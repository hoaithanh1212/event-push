...
export default class DropdownAutocomplete extends Component {
  ...
  findActivities(data) {
    ...
    return data.filter(item => item.name.toUpperCase().includes(query.toUpperCase().trim()));
  }
      ...
      <View style={styles.container}>
        ...
        >
          <View style={{ flex: 8, justifyContent: "center" }}>
            <Text style={{ marginLeft: 5, color: "#333333",
            fontSize: 14, fontFamily: FontNames.RobotoRegular }}>{get(value, 'name', '')}</Text>
          </View>
          <View
